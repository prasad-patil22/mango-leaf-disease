...
An AI-powered web application that detects mango leaf diseases from uploaded images using a Convolutional Neural Network (CNN).

## Features
- Upload mango leaf images
- Detect multiple leaf diseases
